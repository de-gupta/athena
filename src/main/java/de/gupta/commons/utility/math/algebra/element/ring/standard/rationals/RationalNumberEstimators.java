...
{
	public static Estimator<RationalNumber> newton()
	{
		return new Estimator<>()
		{
			@Override
			public UnaryOperator<RationalNumber> estimate(final RationalNumber radicand, final int degree,
			                                              final RoundingStrategy<RationalNumber> rounding)
			{
				return Estimator.<RationalNumber>newton().estimate(radicand, degree, rounding);
			}

			@Override
			public RationalNumber initialEstimate(final RationalNumber radicand, final int degree)
			{
