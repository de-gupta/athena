...
final class IntegerEuclideanDomainStructureTest
{
	...
	final class WhenExposingIdentityElements
	{
		...
		void returnsTheCanonicalZeroAndOneElements()
		{
			assertThat(IntegerEuclideanDomainStructure.INSTANCE.zero()).as("zero")
			                                                           .isEqualTo(IntegerEuclideanDomain.of(0));
			assertThat(IntegerEuclideanDomainStructure.INSTANCE.one()).as("one")
			                                                          .isEqualTo(IntegerEuclideanDomain.of(1));
		}
	}
	...
	final class WhenPerformingArithmetic
	{
		...
		{
			assertThat(IntegerEuclideanDomainStructure.INSTANCE.add(IntegerEuclideanDomain.of(left),
					IntegerEuclideanDomain.of(right)))
					.as(as)
		...
		{
			assertThat(IntegerEuclideanDomainStructure.INSTANCE.multiply(IntegerEuclideanDomain.of(left),
					IntegerEuclideanDomain.of(right)))
					.as(as)
					.isEqualTo(IntegerEuclideanDomain.of(expected));
		}
		...
		{
			assertThat(IntegerEuclideanDomainStructure.INSTANCE.negate(IntegerEuclideanDomain.of(value)))
					.as(as)
					.isEqualTo(IntegerEuclideanDomain.of(expected));
		}
	...
	final class WhenCheckingZeroAndNorm
	{
		...
		{
			assertThat(IntegerEuclideanDomainStructure.INSTANCE.isZero(IntegerEuclideanDomain.of(0)))
					.as("zero element")
					.isEqualTo(true);
			assertThat(IntegerEuclideanDomainStructure.INSTANCE.isZero(IntegerEuclideanDomain.of(5)))
					.as("non-zero element")
					.isEqualTo(false);
		}
		...
		{
			assertThat(IntegerEuclideanDomainStructure.INSTANCE.norm(IntegerEuclideanDomain.of(-9)))
					.as("norm")
					.isEqualTo(9L);
		}
	}
	...
	final class WhenDividingWithRemainder
	{
		...
		{
			DivisionResult<IntegerEuclideanDomain> result =
					IntegerEuclideanDomainStructure.INSTANCE.divideWithRemainder(
							IntegerEuclideanDomain.of(-17), IntegerEuclideanDomain.of(5));

			assertThat(result.quotient()).as("quotient").isEqualTo(IntegerEuclideanDomain.of(-4));
			assertThat(result.remainder()).as("remainder").isEqualTo(IntegerEuclideanDomain.of(3));
		}
	}
}