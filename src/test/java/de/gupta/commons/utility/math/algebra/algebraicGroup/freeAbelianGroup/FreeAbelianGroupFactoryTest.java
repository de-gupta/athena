...
class FreeAbelianGroupFactoryTest
{
	...
	final class CreateMethodTests
	{
																...
																final int expectedEnumConstantsCount)
		{
			...
			// Verify the group can handle all enum constants by creating a non-zero element
	...
	final class EdgeCasesTests
	{
		...
		void testLargeEnum()
		{
			...
			// Verify the group can handle all enum constants by creating a populated element
